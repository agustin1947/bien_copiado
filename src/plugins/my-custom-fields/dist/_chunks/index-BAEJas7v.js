...
const index = {
  register(app) {
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-CWI9J9su.js")).then((module2) => ({
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-B_r0z3Sf.js")).then((module2) => ({
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-y7nDFcfY.js")).then((module2) => ({
