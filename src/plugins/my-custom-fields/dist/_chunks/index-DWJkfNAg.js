...
const SelectCustomizeCuentaCorriente = (props, ref) => {
  ...
  react.useEffect(() => {
    if (!localId) {
      ...
      fetch(`/api/cuenta-corriente?populate=*&filters[documentId][$eq]=${documentId}`).then((res) => res.json()).then((data) => {
        if (!data?.data) return;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("option", { value: "", children: "Seleccione un producto CC" }),
...
exports.SelectCustomizeCuentaCorriente = SelectCustomizeCuentaCorriente;
