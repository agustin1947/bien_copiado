...
const index = {
  register(app) {
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-yZViPbyB.js")).then((module2) => ({
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-BXMCwxsJ.js")).then((module2) => ({
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./index-HROkOrgK.js")).then((module2) => ({
